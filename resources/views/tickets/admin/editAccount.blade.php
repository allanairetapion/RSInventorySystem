								...
								<div class="panel-body">
									<form role="form" class="form-horizontal personalInformation">
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="fname" class="form-control" value="{{Auth::guard('admin')->user()->adminProfile->first_name}}">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label  col-md-3">Last Name:</label>
											<div class="col-md-8">
												<input type="text" name="lname" class="form-control" value="{{Auth::guard('admin')->user()->adminProfile->last_name}}">
											</div>
										</div>
