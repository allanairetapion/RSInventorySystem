			...
			<div>
				<div
					...
					<img id="profilePicture" alt="image" class="img-responsive"
						src="/img/agents/{{Auth::guard('admin')->user()->id}}.jpg" onerror="this.src = '/img/default-profile.jpg'">
				</div>
											...
											<div class="form-group">
												...
												<div class="col-md-8">
													<input type="text" name="fname" class="form-control"
														value="{{Auth::guard('admin')->user()->adminProfile->first_name}}">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-8">
													<input type="text" name="lname" class="form-control"
														value="{{Auth::guard('admin')->user()->adminProfile->last_name}}">
												</div>
											</div>
				...
				<div class="row editPicture">
					<div class="col-md-6">
						<div class="image-crop">
							<img class="img-responsive" src="/img/agents/{{Auth::guard('admin')->user()->id}}.jpg" onerror="this.src = '/img/default-profile.jpg'">
						</div>
					</div>
					<div class="col-md-6">
